    ...
    $.post(options, async (err, resp, data) => {
      try {
        if (err) {
          ...
          if (data) {
            if ($.code === "vLga4Bj" || $.code === "vdgaoof" || $.code === "vMga7Ox") {
